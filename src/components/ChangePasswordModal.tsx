...
export const ChangePasswordModal: React.FC<ChangePasswordModalProps> = ({
  ...
  const isAdmin = (currentUser.globalRole as string) === 'Admin' || (currentUser.globalRole as string) === 'SuperAdmin' || currentUser.department === 'Management' || currentUser.email === 'isarachootip@gmail.com' || currentUser.id === 'u_admin';

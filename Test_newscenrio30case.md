...
| **TS-01-15** | Phase 04: QC, Handover & Settle | Standard Renovate | 1.15 | บันทึกเงินงวดสุดท้าย & ปิดโครงการใน BMT | ใน Tab 3 ตรวจสอบสรุปช่าง INT ➔ บันทึกยอดเงินงวดสุดท้าย ➔ ยืนยันปิดงาน | ยอดเงินงวดสุดท้าย: 60,000 บาท (Paid), ช่างติดตั้ง INT | สถานะโครงการเปลี่ยนเป็น `Completed` สมบูรณ์ | Untested |
